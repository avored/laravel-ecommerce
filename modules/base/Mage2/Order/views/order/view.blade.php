    ...
    <div class="col s12">
        ...
        <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title">Order Basic Info</h3>
        ...
        <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title">Order Item Info</h3>
                <div class="box-tools pull-right">
                    <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse">
                        <i class="fa fa-minus"></i>
                    </button>
        ...
        <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title">Order Address Info</h3>
                <div class="box-tools pull-right">
                    <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse">
                        <i class="fa fa-minus"></i>
                    </button>
            ...
            <div class="box-body">
                ...
                <div class="col-md-6">
                    <h6>Billing Info</h6>
                    <p>
                        {{ $order->billing_address->first_name }} {{ $order->shipping_address->last_name }} <br/>
