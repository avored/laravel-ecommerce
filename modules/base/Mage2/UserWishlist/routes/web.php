...
Route::group(['middleware' => ['web', 'adminauth'], 'namespace' => "Mage2\UserWishlist\Controllers\Admin"], function () {

});


Route::group(['middleware' => ['web', 'frontauth'], 'namespace' => "Mage2\UserWishlist\Controllers"], function () {
