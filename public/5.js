...
var render = function() {
  ...
  return _c(
    "div",
    {
      ...
      staticClass: "relative w-full mb-6"
    },
    [
      _vm.labelText
        ? _c(
            "label",
            {
              staticClass: "text-sm w-full text-gray-600",
      ...
      _c(
        "button",
        {
          staticClass: "border flex w-full border-gray-400 py-2 px-4 rounded",
          attrs: { type: "button" },
          on: {
              ...
              _vm._l(_vm.options, function(optionLabel, optionValue) {
                return [
                  _c(
                    ...
                    {
                      key: optionValue,
                      staticClass: "px-2 py-1 hover:bg-gray-300 cursor-pointer",
