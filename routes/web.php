...
Route::group(['middleware' => 'website'], function () {
    ...
    //Auth::routes();
    Route::get('/login', ['as' => 'front.login', 'uses' => 'Auth\LoginController@showLoginForm']);
    Route::post('/login', ['as' => 'front.logincheck', 'uses' => 'Auth\LoginController@login']);

    Route::get('/logout', ['as' => 'front.logout', 'uses' => 'Auth\LoginController@logout']);

    Route::get('/register', ['as' => 'front.register', 'uses' => 'Auth\RegisterController@getRegister']);
    Route::post('/register', ['as' => 'front.registercheck', 'uses' => 'Auth\RegisterController@postRegister']);
